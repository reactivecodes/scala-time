...
object ZonedDateTime {
  ...
  /** Creates a new [[ZonedDateTime]] instance by querying the current system UTC clock
  ...
  /** Creates a new [[ZonedDateTime]] instance by querying the provided clock
    * for the current date.
    *
    * @return  a new [[ZonedDateTime]]
    */
  ...
  /** Creates a new [[ZonedDateTime]] instance by querying the current system clock with the
    * provided [[ZoneID]] for the current date at provided time zone.
    *
    * @return  a new [[ZonedDateTime]]
    */
  def apply(zone: ZoneID): ZonedDateTime = ZD.now(zone)

  /** Creates a new [[ZonedDateTime]] instance by using a [[TemporalQuery]] to query the EPOCH_DAY field of the provided
  ...
  /** Creates a new [[ZonedDateTime]] instance from a day, month and year. An exception will be thrown if the day is
